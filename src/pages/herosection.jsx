  ...
  return (
    <div className=" pt-[130px] pb-[150px] max-w-[1280px] w-full mx-auto md:px-0 max-md:px-4 h-full bg_herosection relative">
     <div className="max-md:block md:flex max-md:space-y-[47px] justify-between items-center w-[100%]">
        <div className="max-w-[745px] space-y-[16px] w-full">
            ...
            <div>
                {/* <video src=""></video> */}
                <img src={poster} className="max-md:max-w-[100%] md:max-w-[698px]" alt="poster" />
            </div>
        </div>
        <img src={vector1} className="max-md:hidden  absolute max-w-[358.368px] right-[31.5%] z-[4] top-[31%]" alt="SCORP2" />
