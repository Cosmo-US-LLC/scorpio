...
import presaleGgLogo from "../../assets/Widget/presale-gg-logo.svg"
...
const BuyTab = () => {
  ...
  useEffect(() => {
    ...
    if (referralCode) setVisibleOption("referral")
    else if (bonusCode) setVisibleOption("bonus")
  }, [])
    ...
    <>
      ...
      >
        {!apiData.presaleEnded && <>
          <Loadable length={7} component="p" className="md:!text-[14px] max-md:!text-[13px] font-[700] max-md:pr-[2px]">
        ...
        <Loadable length={7} component="p" className="md:!text-[14px] max-md:!text-[13px] font-[700] max-md:pl-[2px]">
      ...
      <button
        ...
        className="btn-primary !text-[20px] !text-[#000] mb-4 mt-2 w-[100%] max-md:py-[14px] md:!py-[16px] h-[3.875rem] relative"
      >
        {transactionLoading ? <Spinner size={7} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" /> : accountData.isConnected ? apiData.presaleEnded ? "Presale Ended" : "Buy Now" : "Connect Wallet"}
      </button>
      <div className="space-y-[8px]">
        <div className="flex justify-center space-x-1">
          <button
            className="!text-[10px] md:!text-[12px] font-[700] max-md:px-[10px] md:px-[10px] flex items-center justify-center py-[5px] cursor-pointer"
            style={{
              borderRadius: "68.376px",
              background: "rgba(0, 0, 0, 0.50)",
            }}
            onClick={() => setVisibleOption((option) => option === "bonus" ? null : "bonus")}
          >
            <svg
            ...
            className="!text-[10px] md:!text-[12px] !font-[700] cursor-pointer max-md:px-[10px] md:px-[10px] flex items-center justify-center py-[5px]"
            style={{
              borderRadius: "68.376px",
              background: "rgba(0, 0, 0, 0.50)",
            }}
          ...
          <button
            ...
            onClick={() => setVisibleOption((option) => option === "referral" ? null : "referral")}
          >
            <svg
              className="mr-1"
              xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <p>
          ...
          {boughtTransaction?.tokens_bought ?? "Unknown"} $SCORP2.0
        </p>
      </Modal>
      <Modal
