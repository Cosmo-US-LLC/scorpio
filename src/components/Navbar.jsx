    ...
    className={`fixed left-0 w-full z-[999] text-white  transition-all duration-300 ${
      ...
      <div className="max-w-[1280px] w-full border-b-[1px] border-white mx-auto md:px-0 max-md:px-4 py-4">
       ...
       <div className="w-full flex justify-between items-center">
        ...
        <button className="md:px-[13px] max-md:px-[12px] max-md:text-[14px] btn-primary cursor-pointer max-md:py-[13px] md:py-[16px]">Connect Wallet</button>
       </div>
      ...
      ></div>
          <div className="space-y-[27px]">
            <h5>
            <a href="#" className="text-[16px] block hover:text-[#B88A44]">What is Scorpion Casino?</a>
            </h5>
            <h5>
          <a href="#" className="text-[16px] block hover:text-[#B88A44]">How to Buy</a>
            </h5>
            <h5>
          <a href="#" className="text-[16px] block hover:text-[#B88A44]">Whitepaper</a>
            </h5>
            <h5>
          <a href="#" className="text-[16px] block hover:text-[#B88A44]">Tokenomics</a>
            </h5>
            <h5>
          <a href="#" className="text-[16px] block hover:text-[#B88A44]">Growth Potential</a>
            </h5>
            <h5>
          <a href="#" className="text-[16px] block hover:text-[#B88A44]">FAQ</a>
            </h5>
               <h5>
          <a href="#" className="text-[16px] block hover:text-[#B88A44]">English</a>
            </h5>
          </div>
          ...
          <div>
            <p className="text-[#fff] text-[14px]">Copyright 2025 Scorpion Casino <br />
