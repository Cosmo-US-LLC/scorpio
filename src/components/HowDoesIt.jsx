  ...
  return (
    <section className="relative w-full  py-16 overflow-hidden">
     ...
     <div className="text-center max-w-[932px] mx-auto mb-[49px]">
          ...
          <p className="text-center">Curious about how the Scorpion Casino ecosystem works? Here’s a simplified explanation. Scorpion Casino is a global Crypto Casino and Sports Betting platform generating daily revenue. This income drives the growth of the $SCORP2.0 Token through an integrated daily Buy-Back, Burn and Reward System.</p>
        </div>
        <div className="relative">
          <img src={howdoesit_img} alt="" />
          <div
        className="absolute bottom-[330px] left-[25%] mx-auto"
        style={{
          width: "762px",
          height: "216px",
          borderRadius: "1262px",
      ...
      ></div>
          ...
          <div className="howdoesit_bg mt-[80px] ">
            <div className="max-w-[1280px] relative mx-auto py-[100px]">
                <div
      ...
      ></div>
          ...
          {badges.map((badge) => (
            ...
            >
              ...
              <h3 className="mb-[20px] text_gradient">
                {badge.title}
              </h3>
